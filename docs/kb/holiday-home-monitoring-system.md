# Holiday Home Monitoring System

Source: https://www.loxone.com/enen/kb/holiday-home-monitoring-system/

---

## Brief: I need a solution to monitor my holiday home remotely.
...
- [Shading Overview](https://www.loxone.com/enen/kb/shading-overview/)
...
- [Touch or Touch Pure](https://shop.loxone.com/enuk/catalogsearch/result/?cat=0&q=touch)

With the help of the Weather Station, which records a wide range of weather data (temperature, wind, precipitation, etc.), the [Miniserver](https://shop.loxone.com/enuk/miniserver.html) recognizes early on when it needs to take measures to protect against a storm or frost.
...
The Smoke Detector Air reliably detects smoke, sounds the alarm and reports the danger to the [Miniserver](https://shop.loxone.com/enuk/miniserver.html). The Miniserver reacts immediately by flashing the lights. In addition, the shading system is raised completely to create escape routes and the music server emits an alarm sound. Thanks to the Caller Service, the owner will be informed about the fire in the holiday home regardless of where they are in the world. We would also recommend installing the Touch or Touch Pure, because the temperature sensor built into it can also be used for early detection of a fire.

The [Fire and Water Alarm](https://www.loxone.com/enen/kb/fire-water-alarm/) Function Block simplifies the programming in the Loxone Config, because e.g. the alarm sequence, etc. is already programmed in it.
...
- [Window Handle Air](https://shop.loxone.com/enuk/window-handle-air.html)
...
- Reset the [Intelligent Room Controllers](https://www.loxone.com/enen/kb/irc-v2/) (stops extension of the heating schedule)
...
### Holiday Home
			...
			[Config 14.02.06.16](https://www.loxone.com/enen/wp-content/uploads/sites/3/2023/11/Use-Case-58-Config-Holiday-Home.loxone)

			[Download Config](https://www.loxone.com/enen/wp-content/uploads/sites/3/2023/11/Use-Case-58-Config-Holiday-Home.loxone)
