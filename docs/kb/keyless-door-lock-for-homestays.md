...
Source: https://www.loxone.com/enen/kb/keyless-door-lock-for-homestays/

---

## Brief: How can I avoid the hassle of handing over and collecting keys with each guest?
...
The [NFC Code Touch](https://shop.loxone.com/enuk/nfc-code-touch.html) is the perfect access solution – offering a keyless door lock solution for Airbnb accommodation. It allows you to quickly and easily assign time-based access codes via the Loxone App.
