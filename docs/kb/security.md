# Overview: Security in a Smart Home

Source: https://www.loxone.com/enen/kb/security/
...
- [Motion Sensor Air](https://www.loxone.com/enen/kb/motion-sensor-air/)
- [Motion Sensor Tree](https://www.loxone.com/enen/kb/motion-sensor-tree/)
- [Door & Window Contact Air](https://www.loxone.com/enen/kb/door-window-contact-air/)
- [Window Handle Air](https://www.loxone.com/enen/kb/window-handle-air/)
- Glass break sensor

#### Secure access in a Loxone Smart Home

The access system in a Loxone Smart Homes should be as easy to handle as possible and still offer maximum security when occupants are away from home. We recommend a door lock motor that automatically locks the front door when closing in conjunction with a personalised access system, eg the NFC Code Touch. With the NFC Code Touch,  the front door can be unlocked via [NFC Key Fob](https://shop.loxone.com/enuk/nfc-key-fob-set.html) or access code  and at the same time the alarm system deactivated. So your customer does not have to explicitly think about deactivating the alarm system, but does both steps in one.
- [NFC Code Touch](https://www.loxone.com/enen/kb/nfc-code-touch/)
...
- [Burglar alarm](https://www.loxone.com/enen/kb/burglar-alarm/)
- [Alarm overview](https://www.loxone.com/enen/kb/security-overview/)
- [NFC Code Touch](https://www.loxone.com/enen/kb/nfc-code-touch/)
...
## Protecting the occupants of a Loxone Smart Home
...
The ‘Fire Kills’ campaign [quotes research](https://www.gov.uk/government/news/fire-minister-urges-households-to-test-smoke-alarms) that you are four times more likely to die in a fire if you live in a home without working smoke alarms. It goes without saying then, that smoke alarms should be an important consideration for any smart home installation.
...
- [Smoke Detector Air](https://www.loxone.com/enen/kb/smoke-detector-air/)*
- [Loxone Touch Air](https://www.loxone.com/enen/kb/touch-air/)
- [Loxone Touch Tree](https://www.loxone.com/enen/kb/touch-air/)
- [Loxone Touch Pure Air](https://www.loxone.com/enen/kb/touch-pure-air/)
- [Loxone Touch Pure Tree](https://www.loxone.com/enen/kb/touch-pure-tree/)
...
*There are regulations around fire safety that new builds and properties going through any major works need to meet. [The Building Regulations 2010](https://www.labc.co.uk/sites/default/files/EXT.Approved-Document-B-Fire-Safety-Vol1-Dwellinghouses-ENG-2013.JMCN_.v1.200417.pdf) Part B section 1.19 to 1.22 states any smoke alarm system should be supported by a permanent electrical supply. The Smoke Detector Air is battery powered and does not have the facility to be permanently powered. If your project does not require building regulation sign-off (such as a retrofit or minor works) then here are some suggestions on offering a feature-rich smart security solution to your customers. If you require building regulation sign-off we do integrate with any third-party fire alarm systems through their relay outputs in order to create notifications, warnings, sirens, etc into the Loxone ecosystem.
...
## Protecting the building in a Loxone Smart Home
...
- [Weather Station Air](https://www.loxone.com/enen/kb/weather-station-air/)
- [Weather Station Tree](https://www.loxone.com/enen/kb/weather-station-tree/)
- [Water Sensor Air](https://www.loxone.com/enen/kb/water-sensor-air/)
...
- [Fire & Water Alarm](https://www.loxone.com/enen/kb/fire-water-alarm/)
...
## Creating a reliable installation in a Loxone Smart Home
