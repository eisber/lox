...
| Summary | Description | Unit | Value Range |
| --- | --- | --- | --- |
| Online Status IR Meter Reader Air | Indicates whether the device can be reached by the Miniserver.Diagnostics for Air devicesDiagnostics for Tree devicesDiagnostics for Extensions | Digital | 0/1 |
...
| Meter Type | Type of MeterPlease note that depending on your supplier not all data may be available. Often power readings are not available! | - | - |
