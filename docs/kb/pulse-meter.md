...
| Abbreviation | Summary | Description | Value Range |
| --- | --- | --- | --- |
| Pf | Power or flow | Power or flow rateCalculated from pulse to pulse time and parameter Np.Pulse interval <= 10 seconds: Updated and calculated by each pulse.Pulse interval > 10 seconds: Update every 10 seconds, calculation of an average value. | 0...∞ |
| Mr | Meter Reading | 0...∞ |
| Rd | Reading today | 0...∞ |
