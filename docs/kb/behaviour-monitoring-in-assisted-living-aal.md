# Behaviour Monitoring in Assisted Living (AAL)

Source: https://www.loxone.com/enen/kb/behaviour-monitoring-in-assisted-living-aal/

---

## Brief: I need a system for automatic behaviour monitoring in assisted living.
...
One of the most used Loxone products in terms of detecting unusual behaviour patterns of seniors is the [Presence sensor](https://shop.loxone.com/enen/catalogsearch/result/?q=presence+sensor). With the Presence Sensor, different situations can be detected. In this example, we have an elderly resident who often has to go to the toilet at night. The probability that the resident will tell a carer/family member this is rather low. For the carer, however, it could be very important information.
...
### Lifestyle Monitoring for Assisted Living
			...
			[Config 14.7.3.6](https://www.loxone.com/enen/wp-content/uploads/sites/3/2024/04/Use-Case-74-Lifestyle-Monitoring-for-Assisted-Living.loxone)

			[Download Config](https://www.loxone.com/enen/wp-content/uploads/sites/3/2024/04/Use-Case-74-Lifestyle-Monitoring-for-Assisted-Living.loxone)
