...
Source: https://www.loxone.com/enen/kb/webpage/
...
| --- | --- | --- |
| URL (local low resolution) | URL for webpage, e.g.: http://192.168.1.7:80/test.html | - |
| URL (local high resolution) | URL for webpage, e.g.: http://192.168.1.7:80/testhd.html | - |
| URL (external low resolution) | URL for webpage, e.g.: http://www.mypage.com/test.html | - |
| URL (external high resolution) | URL for webpage, e.g.: http://www.mypage.com/testhd.html | - |
