...
| ϑt | Target temperature | Min: 30°CMax: 120°C | ° | ∞ |
...
| Pm | Phase mode | Number of phases used:Off = 3 phasesOn = 1 phaseParameter is only displayed if phase outputs (L2) and (L3) are used. | - | 0/1 | 0 |
