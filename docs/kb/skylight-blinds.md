...
| Spe | Sun position automatic end action | 0 = No action1 = Complete open2 = Complete close | - | 0...2 | 1 |
| Dir | Compass direction | Compass direction of the window:0 = north90 = east180 = south270 = west-1 = not configured | ° | -1...359 | -1 |
...
| Pi | Pitch | Roof or window pitch.0 = horizontal90 = vertical | ° | 0...90 | 30 |
