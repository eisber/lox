...
| --- | --- | --- | --- |
| Lc1-18 | Light circuit 1-18 | Output for light circuit 1-18Usage based on actuator type. | 0...100 |
| M | Current mood | Predefined mood IDs:0: Off98: Buzzer (Alarm clock)99: All on-1: User defined mood-3: Multiple moods mixed | -3...99 |
