...
| Txt | Providing the last authorisation detailsThe text is available as long as the output (P) is on. | - |
...
| --- | --- | --- |
| Assigned Device | The following devices are supported:Loxone Intercom1-wire extensionDevices with 1-wire interface | - |
