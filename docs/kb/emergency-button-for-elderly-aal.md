# Emergency Button for Elderly (AAL)

Source: https://www.loxone.com/enen/kb/emergency-button-for-elderly-aal/
...
Buttons remain the most common control element in a home. To give flexible usage, we recommend our [Touch switches](https://shop.loxone.com/enuk/catalogsearch/result/?cat=0&q=touch). Besides single, double and triple taps, specific functions can be defined for a long press on one of the five touchpoints.
...
### Emergency Button
			...
			[Config 14.7.3.6](https://www.loxone.com/enen/wp-content/uploads/sites/3/2024/04/Use-Case-104-AAL-Emergency-Button.loxone)

			[Download Config](https://www.loxone.com/enen/wp-content/uploads/sites/3/2024/04/Use-Case-104-AAL-Emergency-Button.loxone)

## Why you and your customer should consider having an emergency button for elderly people?
...
With Loxone, existing buttons can be used easily and without additional hardware to set up an emergency button for elderly people. As they can be placed in every room, high accessibility of the emergency buttons is guaranteed. This ensures that help can be called quickly in case of an emergency. Additionally, with the [Wrist Button Air](https://shop.loxone.com/enuk/wrist-button-air.html) and the [Button Air](https://shop.loxone.com/enuk/button-air.html), there are also specifically designed alternatives for an Emergency button available.
