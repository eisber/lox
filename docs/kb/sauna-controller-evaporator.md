...
| --- | --- | --- | --- | --- |
| Mode | Select sauna mode | 0 = Off / Manual1 = Finnish manual2 = Humidity manual3 = Finnish sauna4 = Herbal sauna5 = Soft steam bath6 = Hot-air bath | - | 0...6 |
...
| ϑt | Target temperature | Min: 30°CMax: 110°C (Finnish manual)Max: 70°C (Humidity manual) | ° | ∞ |
...
| Mode | Current sauna mode | 0 = Off / Manual1 = Finnish manual2 = Humidity manual3 = Finnish sauna4 = Herbal sauna5 = Soft steam bath6 = Hot-air bath | - | ∞ |
...
| Pm | Phase mode | Number of phases used:0 = 3 phases1 = 1 phase2 = 2 phases in Evaporator mode or 3 phases in mode without Evaporator.Parameter is only displayed if phase outputs (L2) and (L3) are used. | - | 0...2 | 2 |
