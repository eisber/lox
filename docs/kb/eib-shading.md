...
| --- | --- | --- | --- |
| Lo | Long-term operation | -1 = passive0 = open1 = closeConnect this output to an EIB-actuator (group address for long-term operation of blinds) | ∞ |
| So | Short-term operation | -1 = passive0 = open1 = closeConnect this output to an EIB-actuator (group address for short-term operation of blinds) | ∞ |
